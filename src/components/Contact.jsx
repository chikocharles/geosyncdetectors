  ...
  const contactInfo = [
    {
      icon: Phone,
      title: "Phone Numbers",
      details: ["+263774679132", "+263710297912"],
      color: "text-blue-600"
    },
    {
      icon: Mail,
      title: "Email Address",
      details: ["geosyncinvestments@gmail.com"],
      color: "text-green-600"
    },
    {
      icon: MapPin,
      title: "Physical Address",
      details: ["STD No -622, R. Manyika & 2nd street", "Shop -A09, Harare, Zimbabwe"],
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Ready to discover hidden treasures? Contact us today for expert consultation and get the perfect gold detector for your needs.
          </p>
        </motion.div>
        ...
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <div className="bg-gradient-to-br from-blue-50 to-yellow-50 rounded-3xl p-8 shadow-lg">
              ...
              {contactInfo.map((info, index) => (
                ...
                >
                  <div className="flex items-start space-x-4">
                    <div className={`w-12 h-12 rounded-xl flex items-center justify-center ${info.color} bg-opacity-10`}>
